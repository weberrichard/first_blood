...
% main parameters
HR  = 75;  % heart rate
per = 10; % number of simulation periods
...
z = zeros(4,nt*per+1);
z(:,1) = [LVV0/1000/1000-V0; Pla0* mmHg_Pa; 0* mmHg_Pa; qa0];
...
EC3(1) = 0;
EL(1)  = .5*L*z(4,1)^2;
Ener1 = EC1(1) + EC2(1) + EC3(1) + EL(1);

Pa0 = sqrt(2*(Ener0 - Ener1)/C3);
Pa(1) = Pa0/mmHg_Pa;
z(3,1) = Pa0;
EC3(1) = .5*C3*z(3,1)^2;
