...
int main(int argc, char* argv[])
{
   ...
   {
      cout << "Incorrect number of inputs (" << argc << "). Right one: 41" << endl;
      exit(-1);
   }
   ...
   vector<string> el{"A1","A2","A3","A5","A8","A12","A14","A16","A18","A20","A27","A28","A35","A37","A39","A41","A43","A44","A46","A48","A95"};
   ...
   if(is_run_ok)
   {
      ...
      //fb->save_initials("Reymond_99_heart_ref3","models");
